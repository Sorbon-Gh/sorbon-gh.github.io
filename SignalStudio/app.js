document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mobileBtn && navLinks) {
        mobileBtn.addEventListener('click', () => {
            ...
            navLinks.style.top = isOpen ? '' : '60px';
            ...
            navLinks.style.background = getComputedStyle(document.documentElement).getPropertyValue('--bg-main').trim();
    ...
    const signalTypes = {
        ...
        gaussian: (x) => {
            const period = 0.5, sigma = period / 6;
    ...
    function drawAllSignals() {
        ...
        const bgColor = isDark ? '#080b10' : '#f0f2f5';
        const gridColor = isDark ? 'rgba(24, 144, 255, 0.06)' : 'rgba(0, 100, 200, 0.06)';
        const curveColor = isDark ? '#00ff41' : '#1a7f37';
